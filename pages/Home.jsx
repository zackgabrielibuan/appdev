        ...
        const filterCars = () => {
            const filtered = cars.filter((car) => {
                ...
                return (
                    ...
                    car.price >= minPrice &&
                    car.price <= maxPrice &&
                    (filters.carType ? car.type === filters.carType : true) &&
                    car.rentalPeriod === filters.rentalPeriod
                );
            });
        ...
        <div>
            ...
            >
                <div className="hero-content">
                    <h1>Welcome to VIAJE Car Rentals</h1>
                    <button className="cta-button" onClick={() => navigate('/renting/1')}>
                        Rent Your Car Now
                    </button>
                </div>
            </motion.section>
                ...
                {filteredCars.length > 0 ? (
                    filteredCars.map((car) => (
                        ...
                        >
                            ...
                            <h2>{car.brand}</h2>
                            <p>Price: {formatPrice(car.price)} per {car.rentalPeriod}</p>
                            <p>Type: {car.type}</p>
                        </motion.div>
                    ))
                ) : (
